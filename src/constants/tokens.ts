...
// const OHM_CUSTOM_PRICE = async () => {
//   console.log('debug custom price')
...
export const OHM_DAI_LP_TOKEN = new Token({
  ...
  purchaseUrl:
    "https://app.sushi.com/add/0x48983D42dDC25E98b738c231c022e22ef0a851CC/0x6b175474e89094c44da98b954eedeac495271d0f",
});
