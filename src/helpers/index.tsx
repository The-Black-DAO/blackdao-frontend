...
export async function getMarketPrice() {
  ...
  // const pairContract = new ethers.Contract(OHM_DAI_LP_TOKEN.getAddress(NetworkId.MAINNET), PairContract.abi, provider)
  const reserves = await contract.getReserves();
  console.log('debug get market reserves', reserves)
