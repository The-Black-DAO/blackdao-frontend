...
// export const SUBGRAPH_URL = "https://api.thegraph.com/subgraphs/name/jamesbwn/black-graph"; // goerli testnet
export const SUBGRAPH_URL = "https://api.thegraph.com/subgraphs/name/jamesbwn/black-main-gv5";
