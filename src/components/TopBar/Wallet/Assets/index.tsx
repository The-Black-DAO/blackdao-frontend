...
import OHMLogo from '../../../../assets/tokens/token_BLKD.png'
      ...
      <Box>
        <Box display="flex" flexDirection="row" justifyContent="space-between">
          <WalletBalance
            ...
            underlyingBalance={`${formatNumber(walletTotalValueUSD / (ohmPrice !== 0 ? ohmPrice : 1), 2)} BLKD`}
          />
        </Box>
            ...
            default:
              return (
                ...
                <div className='balance-container'>
                  <div style={{display: 'flex', justifyContent: 'space-between'}}>
                    <div style={{width: '50%', alignItems: 'center', display: 'flex'}}>
                      <img src={OHMLogo} alt="BLKD Logo" width='34px' height='34px'/>
                      <Typography style={{marginLeft: '5px'}}> BLKD </Typography>
                    </div>
                    <div style={{display: 'grid'}}>
                      <Typography> {formattedohmBalance}</Typography>
                      <text style={{color: '#A3A3A3'}}> ${ohmPrice * parseFloat(formattedohmBalance)}</text>
                    </div>
                  </div>
                </div>
                ...
                <div className='balance-container'>
                  <div style={{display: 'flex', justifyContent: 'space-between'}}>
                    <div style={{width: '50%', alignItems: 'center', display: 'flex'}}>
                      <img src={OHMLogo} alt="sBLKD Logo" width='34px' height='34px'/>
                      <Typography style={{marginLeft: '5px'}}> sBLKD </Typography>
                    </div>
                    <div style={{display: 'grid'}}>
                      <Typography> {formattedSOhmBalance} </Typography>
                      <text style={{color: '#A3A3A3'}}> ${ohmPrice * parseFloat(formattedSOhmBalance) }</text>
                    </div>
                  </div>
                </div>
                ...
                <div className='balance-container'>
                  <div style={{display: 'flex', justifyContent: 'space-between'}}>
                    <div style={{width: '50%', alignItems: 'center', display: 'flex'}}>
                      <img src={OHMLogo} alt="gBLKD Logo" width='34px' height='34px'/>
                      <Typography style={{marginLeft: '5px'}}> gBLKD </Typography>
                    </div>
                    <div style={{display: 'grid'}}>
                      <Typography> {formattedgOhmBalance}</Typography>
                      <text style={{color: '#A3A3A3'}}> ${gOhmPrice * parseFloat(formattedgOhmBalance)}</text>
                    </div>
                  </div>
                </div>
                  {assets.map(asset => (
