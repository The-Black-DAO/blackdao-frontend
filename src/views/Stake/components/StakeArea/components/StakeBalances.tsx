  ...
  return (
    <>
      <DataRow
        ...
        balance={`${formatBalance(ohmBalance)} BLKD`}
      />
      ...
      <Accordion className="stake-accordion" square defaultExpanded>
        <AccordionSummary expandIcon={<ExpandMore className="stake-expand" />}>
          <DataRow
            ...
            balance={`${totalStakedBalance} sBLKD`}
          />
        </AccordionSummary>
        ...
        <AccordionDetails>
          <DataRow
            ...
            balance={`${formatBalance(sohmBalance)} sBLKD`}
          />
          ...
          <DataRow
            ...
            balance={`${formatBalance(gohmBalances[networks.MAINNET].data)} gBLKD`}
          />
