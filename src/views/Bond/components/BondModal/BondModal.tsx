...
import BlkdLogo from "src/assets/tokens/token_BLKD.png"
import LpLogo from 'src/assets/tokens/blkd_dai.png'
  ...
  return (
    <Modal
      ...
      headerContent={
        ...
        {
        bond.quoteToken.name === 'BLKD-DAI LP' ? 
          <img src={LpLogo} width='69px' height={'40px'} />
         : 
        ...
        <Box display="flex" flexDirection="row" justifyContent="space-around" width={["100%", "70%"]} mt="24px">
          ...
          <Box display="flex" flexDirection="column" alignItems="center">
            ...
            <Typography style={{ lineHeight: "20px" }}>
              ...
              <img src={BlkdLogo} alt='blkd logo' width='40px' height='40px' />
            </Typography>
          </Box>
        </Box>
...
const TokenPrice: React.VFC<{ token: Token; isInverseBond?: boolean }> = ({ token, isInverseBond }) => {
  ...
  const price = formatCurrency(ohmPrice, 2);
